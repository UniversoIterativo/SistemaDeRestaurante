	...
	<tr>
		...
		<td>
			<form:select path="tipo" required="required">
				<form:option value="SELECIONE O TIPO DE OPERACAO"></form:option>
...
<c:if test="${!empty listMovimentacoes}">
	<table class="tg">
	<tr>
		<th width="80">Movimentacao ID</th>
		<th width="120">Movimentacao Conta</th>
		<th width="120">Movimentacao Valor</th>
		<th width="60">Edit</th>
